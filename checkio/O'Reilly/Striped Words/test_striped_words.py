...
from striped_words import checkio


class Tests(unittest.TestCase):
    TESTS = {
        "Basics": [
            {"input": "My name is ...", "answer": 3, "explanation": 0},
            {"input": "Hello world", "answer": 0, "explanation": 0},
            {"input": "A quantity of striped words.", "answer": 1, "explanation": 0},
            {"input": "Dog,cat,mouse,bird.Human.", "answer": 3, "explanation": 0},
        ],
        "Extra": [
            {
        ...
        "Extra2": [
            {"input": "1 2 3 12 13", "answer": 0},
            {"input": "1st 2a ab3er root rate", "answer": 1},
            {"input": "JJJ:qwerty,iddqd,hoho", "answer": 1},
            {"input": "I can see dead people. yes,no.", "answer": 2},
            {
            ...
            {"input": "I", "answer": 0},
            {"input": "z", "answer": 0},
            {"input": "AbA is not ABBA", "answer": 3},
            {"input": "o" * 1000, "answer": 0},
            {"input": "ab" * 400, "answer": 1},
        ],
    }
