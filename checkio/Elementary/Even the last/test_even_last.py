...
class Tests(unittest.TestCase):
    TESTS = {
        "Basics": [
            ...
            {"input": [6], "answer": 36, "explanation": "6*(6)"},
            {"input": [], "answer": 0, "explanation": "The empty array"},
        ],
        "Extra": [
            {"input": [-45], "answer": 2025, "explanation": "-45*(-45)"},
            {
            ...
            {"input": [39], "answer": 1521, "explanation": "39*(39)"},
            {
                "input": [
                    -37,
                    -36,
