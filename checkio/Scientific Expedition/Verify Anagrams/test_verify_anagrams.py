...
class Tests(unittest.TestCase):
    TESTS = {
        "0. Basics": [
            ...
            {"input": ["Hello", "Ole Oh"], "answer": False, "common": "helo"},
            {"input": ["Kyoto", "Tokyo"], "answer": True, "common": "kyoto"},
        ],
        "1. Extra": [
            {"input": ["Hamlet", "Amleth"], "answer": True, "common": "hamlet"},
            {
                "input": ["Kings Lead Hat", "Talking Heads"],
                "answer": True,
                "common": "kingsleadhat",
            },
            {"input": ["Hello", "Hell"], "answer": False, "common": "hel"},
            {
                "input": [
            ...
            {"input": ["Listen", "Silent"], "answer": True, "common": "listen"},
            {
        ...
        "2. Edge": [
            {"input": ["a", "a"], "answer": True, "common": "a"},
            {"input": ["x", "X"], "answer": True, "common": "x"},
            {"input": ["A O X", "x o a"], "answer": True, "common": "aox"},
            {"input": ["  Hi  all  ", "all hi"], "answer": True, "common": "hiall"},
            {"input": ["a", "z"], "answer": False, "common": ""},
            {
                "input": [
            ...
            {"input": ["aaaaaaaaabbb", "ba"], "answer": False, "common": "ab"},
            {"input": ["a", "abcd"], "answer": False, "common": "a"},
        ],
    }
