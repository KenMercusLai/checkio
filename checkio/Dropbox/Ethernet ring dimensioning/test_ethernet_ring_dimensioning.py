...
def test_segment_bandwidth():
    assert segment_bandwidth('AEFCBG', [("AC", 5), ("EC", 10), ("AB", 60)]) == {
        'AE': 5,
        'EF': 15,
        'FC': 15,
        'CB': 0,
...
class Tests(unittest.TestCase):
    TESTS = {
        "Basics": [
            ...
            {"input": ["ABCDEFGH", ("AD", 4)], "answer": [0, 0, 3, 0, 0]},
            {"input": ["ABCDEFGH", ("AD", 4), ("EA", 41)], "answer": [4, 0, 3, 0, 0]},
        ],
        "Extra": [
            {
            ...
            {"input": ["ABCDEFGH", ["AD", 4], ["DA", 4]], "answer": [0, 0, 3, 0, 0]},
            {
